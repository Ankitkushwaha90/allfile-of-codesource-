...
<body>
	...
	<nav>
		...
		<ul id="useid">
			...
			<li class="active"><a href="../PHP_Folder/PHP_introduction.php">PHP</a></li>
...
$india = array("delhi", "mumbai", "agra");// Indexed arrays

echo " $india[1] <br/>";


$ass = array("hello" => "Welcome", "next" => "back", "beauty" => "Awesome"); // Associative arrays

echo " $india['hello'] <br/>";


$india = array(
array("delhi", "mumbai", "agra",
array("delhi", "mumbai", "agra", );
