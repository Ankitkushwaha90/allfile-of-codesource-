...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../@Manage_files/div2a.css">
...
<!-- 
 ...
 -->
		...
		<ul id="useid">
			<li class="active"><a href="../HTML_Folder/HTML_introduction.php">HTML</a></li>
			<li><a href="../CSS_Folder/CSS_introduction.php">CSS</a></li>
			<li><a href="../CREATE_Folder/CREATE_introduction.php">CreateWeb</a></li>
	...
	<div class="maincss">
		...
		<div class="maindiv2">
			...
			<div class="mainw1">
				<div class="box3"></div>
				<div class="textha3">HTML (Hyper Text Marup Language)</div>
				<div class="textha5">Use making page of website And attached to link page of website.</div>
			...
			<div class="mainw1">
				...
				<div class="textha4">Save formate file</div>
				<div class="textha6">This is HTML sample code by using sample tag of html. It is all tag in html tag.</div>

				<div class="a1a">
					<img src="img/html2.jpg" class="img1a2">
			...
			<div class="mainw1">
				<div class="box4"></div>
				<div class="textha4">Sample Syntax of HTML code</div>
				<div class="textha6">It is using of html, head, title ,body and h1 tag.</div>
				...
				<div class="textha4">Look of web page</div>
				<div class="textha6">It is page use of h1 tag in HTML.</div>
				<div class="a1a">
					
					<img src="img/html1.jpg"  class="img1a1">	
				</div>
